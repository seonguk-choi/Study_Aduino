...
void loop() { 
    ...
    if (ESP8266.available() && sendDataState == 0) { 
      String result = ""; 
      ...
      char result_char[data.length()];
        ...
        if(strcmp(id0, idLed) == 0){
          digitalWrite(13, atoi(value0)); // 전등값
          digitalWrite(12, atoi(value1)); // 쎄콤값
          delay(100);          
        }else if(strcmp(id0, idSec) == 0){
          digitalWrite(13, atoi(value1));
          digitalWrite(12, atoi(value0));
          delay(100);
        }  
  ...
  while(1){
    ...
    if(ESP8266.find("OK")){
      ...
      delay(1500);
       ...
       ESP8266.println("AT+CIPSTO=2"); // SET SERVER TIMEOUT
       delay(1000);
       printResponse();
